...
Source of model_evaluation_utils module:
...
# =============================================================================
#   model performance evaluation (MNB)
# =============================================================================
    
    #  get accuracy, precision, recall, F1 score for MNB model
    print('\n')
    print('Get accuracy, precision, recall, F1 score for MNB model')
...
# =============================================================================
#   model performance evaluation of (LR)
# =============================================================================   
    
    # get accuracy, precision, recall, F1 score for Logistic Regression model
    print('\n')
 ...
 # =============================================================================   
    ...
    # get accuracy, precision, recall, F1 score for SVM model
    print('\n')
